...
const TESTIMONIALS = [
  { name: 'Fatimata B.', role: 'Étudiante en soins infirmiers', text: 'J\'ai réussi mon concours du premier coup grâce à Al Bourour. Les QCM sont vraiment adaptés au programme mauritanien.', stars: 5 },
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100/80 shadow-sm">
        <div className="w-full px-6 lg:px-10 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-extrabold text-lg tracking-tight text-gray-900">Al Bourour</span>
          </div>
      ...
      <footer className="border-t border-gray-100 py-8 px-6 lg:px-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-600">Al Bourour</span>
