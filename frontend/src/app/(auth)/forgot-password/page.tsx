    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-[55%] flex-col relative overflow-hidden"
        ...
        <div className="relative flex flex-col h-full p-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <p className="text-sky-300 text-sm font-semibold uppercase tracking-[0.2em] mb-4">Modifier mon mot de passe</p>
            <h1 className="text-5xl font-extrabold text-white leading-[1.1] mb-6">
              Une mise à jour rapide<br />et sécurisée.
            </h1>
            <p className="text-white/55 text-base leading-relaxed max-w-md">
              Entrez votre email et choisissez un nouveau mot de passe. La modification se fait directement, sans lien de validation.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-background">
        <div className="w-full max-w-md">
          <div className="mb-8">
            <h2 className="text-3xl font-extrabold tracking-tight">Modifier mon mot de passe</h2>
            <p className="text-muted-foreground text-sm mt-1">Saisissez votre email et votre nouveau mot de passe.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 bg-card border border-border rounded-3xl p-8 shadow-xl shadow-black/5">
            <div>
              <label htmlFor="email" className="block text-sm font-semibold mb-2">Adresse email</label>
              <input
                id="email"
                name="email"
                type="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-semibold mb-2">Nouveau mot de passe</label>
            ...
            >
              ...
              {loading ? 'Réinitialisation...' : 'Modifier mon mot de passe'}
            </button>
          </form>
